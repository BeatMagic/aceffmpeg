...
#
# Builds LAME 3.100, Opus 1.5.2, and FFmpeg 8.1 with debug symbols (-g).
# Unlike the release build, the output is NOT stripped — full DWARF debug info is preserved.
# FFmpeg still uses -O2 (required to avoid linker errors from dead-code elimination patterns).
